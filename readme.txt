...
1.unzip server-work.zip (unzip path C:\dev)
2.JAVA_HOME = C:\dev\server-work\java\zulu8.31.0.1-jdk8.0.181-win_x64
...
# WAS (tomcat)
	...
	-[SERVER-WORK] ADD , [SERVER-WORK] MODIFY 주석 부분 참고
	
	1.tomcat_users.xml
	C:\dev\server-work\tomcat1\apache-tomcat-9.0.37\conf\tomcat_users.xml
	C:\dev\server-work\tomcat2\apache-tomcat-9.0.37\conf\tomcat_users.xml
	
	2.server.xml
	C:\dev\server-work\tomcat1\apache-tomcat-9.0.37\conf\server.xml
	C:\dev\server-work\tomcat2\apache-tomcat-9.0.37\conf\server.xml
	
		-Clustering/Session Replication How-To
		https://tomcat.apache.org/tomcat-9.0-doc/cluster-howto.html

	3.start (CATALINA_HOME 환경변수 설정 안한 경우 bin 디렉 토리 밑에서 실행)
	C:\dev\server-work\tomcat1\apache-tomcat-9.0.37\bin\startup.bat
	C:\dev\server-work\tomcat2\apache-tomcat-9.0.37\bin\startup.bat
...
# Build Tool (Maven)
	...
	-[SERVER-WORK] MODIFY 주석 부분 참고
	
	1.setting.xml
	C:\dev\server-work\maven\apache-maven-3.6.3\conf\settings.xml 
...
# Source Version Control (svn)
	...
	1.svn repository 생성 
	C:\dev\server-work\svn\bin\svnadmin create C:\dev\server-work\svn_repository

	2.사용 권한 설정
	C:\dev\server-work\svn_repository\conf\svnserve.conf 파일에 하단 내용 추가 
	[general]
	anon-access = read
	auth-access = write
	password-db = passwd
	...
	3.사용자 생성
	C:\dev\server-work\svn_repository\conf\passwd 파일에 하단 내용 추가
	svnadmin = svnadmin

	4.서비스 등록 (cmd 창을 관리자 권한으로 실행하고 명령문 실행)
	sc create SVNserve binpath= "C:\dev\server-work\svn\bin\svnserve.exe  --service --root \"C:\dev\server-work\svn_repository\"" displayname= "Subversion Repository" depend= Tcpip start= auto

	5.프로젝트 폴더 등록
	set SVN_EDITOR=C:\Windows\notepad.exe
	C:\dev\server-work\svn\bin\svn mkdir svn://localhost/demo
...
# Example web Project (demo) 개발 환경 - STS 사용 
	...
	C:\dev\server-work\tomcat1\apache-tomcat-9.0.37\webapps
	C:\dev\server-work\tomcat1\apache-tomcat-9.0.37\webapps
...
# CI (jenkins)
	...
	C:\dev\server-work\jenkins\jenkins\start.bat
	
	start.bat 파일 내용
	-----------------------------------------------
		cd C:\dev\server-work\jenkins

		set JENKINS_HOME=C:\dev\server-work\jenkins_home

		rem C:\dev\server-work\java\zulu8.31.0.1-jdk8.0.181-win_x64\bin\java -jar jenkins.war --httpPort=9999
	...
	- jenkins review
		 ...
		 *jenkin_repository 디렉토리 살펴보기 
			C:\dev\server-work\jenkins_home\jobs
			C:\dev\server-work\jenkins_home\workspace			
...
# WEB Server (Apache2)
	...
	-----------------------------------------------
	cmd(admin) : C:\dev\server-work\Apache2\bin
	...
	1.httpd.conf 
	C:\dev\server-work\Apache2\conf\httpd.conf
		...
		C:\dev\server-work\Apache2\conf\workers_jk.properties
		C:\dev\server-work\Apache2\conf\uriworkermap.properties
	
		-mod_jk.so modules 폴더에 추가 
		C:\dev\server-work\Apache2\modules\mod_jk.so		
		
    2.httpd-ssl.conf
	C:\dev\server-work\Apache2\conf\extra\httpd-ssl.conf
	
	3.httpd-vhosts.conf
	C:\dev\server-work\Apache2\conf\extra\httpd-vhosts.conf		
...
# Stress Test (jmeter)
	...
	-Run
	C:\dev\server-work\jmeter\apache-jmeter-5.3\bin\jemeter.bat
	
	-Open File
	C:\dev\server-work\jmeter\sample.jmx	
...
# APM (scouter)
	...
	C:\dev\server-work\scouter\scouter-all-2.8.1\server\startup.bat

	-scouter host
	C:\dev\server-work\scouter\scouter-all-2.8.1\agent.host\host.bat
	...
	C:\dev\server-work\tomcat1\apache-tomcat-9.0.37\bin\startup.bat
		...
		set "JAVA_OPTS=%JAVA_OPTS% -Dscouter.config=C:/dev/server-work/scouter/scouter-all-2.8.1/agent.java/conf/tomcat1.conf"
	...
	C:\dev\server-work\scouter\scouter.client\scouter.exe	
...
# Monitoring (elk)
	...
	-elasticsearch
		C:\dev\server-work\elk\elasticsearch-7.5.0\bin\elasticsearch.bat
		http://127.0.0.1:9200/
	...
	-logstash( 처음 설치 시 plugin update)
		...
		C:\dev\server-work\elk\logstash-7.5.0\bin\logstash.bat -f C:\dev\server-work\elk\logstash-7.5.0\config\logstash.conf
			
	-filebeat
		C:\dev\server-work\elk\filebeat-7.5.0\filebeat.exe -c C:\dev\server-work\elk\filebeat-7.5.0\filebeat.yml -e -v

	-kibana (Node 설치필요)
		C:\dev\server-work\elk\kibana-7.5.0\bin\kibana.bat
		http://127.0.0.1:5601/
